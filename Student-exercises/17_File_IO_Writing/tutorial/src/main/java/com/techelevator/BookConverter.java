...
public class BookConverter {
    public static void main(String[] args) {
        /*
         * This book-converter program opens a file that was downloaded from https://www
         * .gutenberg.org/,
        ...
        System.out.print("Enter path to the book file: "); String filePath = userInput.nextLine();
        ...
        try (Scanner fileInput = new Scanner(bookFile)) {
            ...
            while (fileInput.hasNextLine()) {
                ...
                String lineOfText = fileInput.nextLine(); lineCount++;

                // Print the file to the user
                System.out.println(lineOfText); writer.println(lineOfText.toUpperCase());
            }
            String message = "Converted" + lineCount + "lines of file " + bookFile.getName() +
                    "to " + convertedFile.getName() + " on " + new Date();
            System.out.println(message);
        } catch (FileNotFoundException e) {
            // Could not find the file at the specified path.
            System.out.println("The file was not found: " + bookFile.getAbsolutePath()); return;
        }

        // Tell the user what happened.
        String message = "Displayed " + lineCount + " lines of file " + bookFile.getName();
        System.out.println(message);
        ...
        contents will be preserved, and the lines written here will be appended to what was
        already there.
         */
     ...
     * If the is no extension on the input file ("myFile"), then ".screaming" will just be
     * appended ("myFile.screaming").
     *
    ...
    static private File getConvertedFile(File bookFile) {
        ...
        int dotIndex = bookPath.lastIndexOf('.'); String convertedPath; if (dotIndex >= 0) {
            // found an extension, like .txt
            convertedPath =
                    bookPath.substring(0, dotIndex) + ".screaming." + bookPath.substring(dotIndex + 1);
        } else {
