...
public class Bookstore {
    ...
    public static void main(String[] args) {
        ...
        twoCities.setAuthor("help");
        twoCities.setPrice(14.99);
        //System.out.println("Title: " + twoCities.getTitle() + ", Author: " + twoCities
        // .getAuthor() + ", Price: " + twoCities.getPrice());
        ...
        //System.out.println("Title: " + childhoodEnd.getTitle() + ", Author: " + childhoodEnd
        // .getAuthor() + ", Price: $" + childhoodEnd.getPrice());
