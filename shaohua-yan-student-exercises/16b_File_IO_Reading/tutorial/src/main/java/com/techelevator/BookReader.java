...
public class BookReader {
    ...
    public static void main(String[] args) {
        /*
         * This book-reader program opens a file that was downloaded from https://www.gutenberg
         * .org/, reads
         * through the copyright information at the top until it finds the start of the book
         * content, and
         * then displays the content to the user. It also counts the total lines of book content
         * between the
        ...
        try (Scanner fileInput = new Scanner(bookFile)) {
            ...
            // unable to find the file at path
