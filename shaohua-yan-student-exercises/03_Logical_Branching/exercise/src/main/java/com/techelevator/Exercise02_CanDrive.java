...
public class Exercise02_CanDrive {
    ...
    Implement the logic to return true if the person has a permit and is with a licensed
    passenger who is 21 or over.
    ...
    public boolean canDrive(boolean hasPermit, boolean withLicensedPassenger, int passengerAge,
        ...
        return hasPermit && withLicensedPassenger && (!isPassengerOurGuardian ? passengerAge >= 21 : passengerAge >= 18);
    }
}
