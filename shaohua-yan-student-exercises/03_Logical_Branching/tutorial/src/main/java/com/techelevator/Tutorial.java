...
public class Tutorial {
    public static void main(String[] args) {
        ...
        // Step Six: Advise the user on the type of jacket they should be wearing. (<= 0°F, <=
        // freezing, < 65°F)
        ...
        // Step Seven: If the temperature delta for the day is more than 20°F, advise the user to
        // dress in layers.
        int lowTemperatureF = 34;
        if (highTemperatureF - lowTemperatureF > 20) {
            System.out.println("* Dress in layers today, as the temperature may swing " +
                    "dramatically.");
        }
